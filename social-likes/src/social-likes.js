...
(function (factory) {  // Try to register as an anonymous AMD module
	...
	if (!JQUERY_VERSION || JQUERY_VERSION[0] < 1 || (+JQUERY_VERSION[0] === 1 && JQUERY_VERSION[1] < 7)) {
	  throw 'Sharerama requires jQuery 1.7 or later and will not run without it.';
	}
